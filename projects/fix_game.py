...
def start_game():
    ...
    while not game_over:
        ...
        if attempts >= max_attempts:
            ...
            game_over = True
        elif guess == number_to_guess: #There cannot be 2 if conditionals, this is wrong because both will be checked, (syntax)
            print("Congratulations! You've guessed the number!")
            game_over = True
        elif guess > number_to_guess:
            print("Too high! Try again.")
            attempts=attempts+1 #adds one to the attempts
        elif guess < number_to_guess:
...
#qwertyuiopasdfghjklzxcvbnm false true \ / ! >< + =() #