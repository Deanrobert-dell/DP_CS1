...
def start_game():
    ...
    game_over = False
    while not game_over:
        guess = float(input("Enter your guess: ")) #wrong type of data, the > operator doesnt work with integers and strings (runtime)
...
#continue didn't do anything, this didnt stop code but it was useless (logic)